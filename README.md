...
✨ Features
Mobile-First Design: Optimized for seamless viewing on all smartphones.
...
Bash
git clone https://github.com/arasargsyan1/invitation-project.git
...
📱 Mobile View
For the best experience, open the browser's Developer Tools (F12) and toggle the Device Toolbar to see the mobile layout.
